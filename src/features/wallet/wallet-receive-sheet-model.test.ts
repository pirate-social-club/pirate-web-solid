...
test("unpriced token balances never imply a zero-dollar receive balance", () => {
  expect(formatFiatTotal({ chainId: "ethereum", title: "Ethereum", availability: "ready", tokens: [{ id: "eth", symbol: "ETH", name: "Ether", balance: "1" }] })).toBe("—");
});
