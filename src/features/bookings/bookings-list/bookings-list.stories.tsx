...
const meta = { title: "App/Bookings/BookingsList", component: BookingsList, args: { items: [], viewerTimezone: "Europe/Vienna" }, parameters: { layout: "fullscreen", a11y: { test: "error" } } } satisfies Meta<typeof BookingsList>;
export default meta;
