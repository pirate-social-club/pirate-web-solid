...
export const StandardRouteMobile: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <div class="min-h-screen bg-background"><StandardRoutePage size="rail"><StoryContent bleed /></StandardRoutePage></div> };
export const StandaloneMobile: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <StandaloneMobilePage title="Settings" onBack={() => undefined}><div class="flex flex-1 flex-col gap-4 px-[var(--page-gutter-x)] py-4"><Card class="p-5"><Type variant="body">Standalone mobile page content.</Type></Card></div></StandaloneMobilePage> };
...
export const PublicRouteMobile: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <PublicRoutePage><div class="flex flex-col gap-4 py-6"><Card class="p-5"><Type variant="body">Public route content.</Type></Card></div></PublicRoutePage> };
