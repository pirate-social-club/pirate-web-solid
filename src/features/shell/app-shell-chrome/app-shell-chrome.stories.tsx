...
export const MobileHeader: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <div class="min-h-screen bg-background"><AppHeader forceMobile labels={labels} showWalletAction /><Body>Mobile header chrome</Body></div> };
export const MobileMediaOverlayHeader: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <div class="relative min-h-screen bg-gradient-to-br from-muted to-card"><AppHeader forceMobile hideMobileBrand labels={labels} mobileAppearance="media-overlay" mobileCenterContent={<Type as="span" variant="h4">Pirate</Type>} /><Body>Media overlay keeps controls legible over video</Body></div> };
