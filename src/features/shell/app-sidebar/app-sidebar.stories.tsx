...
export const MobileShell: Story = { globals: { viewport: { value: "mobile1", isRotated: false } }, render: () => <div class="flex min-h-screen"><AppSidebar class="hidden md:flex" brandLabel="PIRATE" primaryItems={primary} sections={sections} /><Content label="Mobile content shell" /></div> };
