...
export function AppSidebar(props: AppSidebarProps) {
  ...
  return <aside aria-label={props.brandLabel ?? "Pirate navigation"} class={cn("flex min-h-screen w-72 shrink-0 flex-col border-e border-sidebar-border bg-sidebar p-4 text-sidebar-foreground", props.appearance === "media" && "bg-black text-white", props.collapsed && "w-20 px-2", props.class)}>
