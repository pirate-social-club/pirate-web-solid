...
const base = { title: "Your communities", createCommunityLabel: "Create", followingLabel: "Following", joinedLabel: "Joined", emptyFollowingLabel: "You are not following any communities.", emptyJoinedLabel: "You have not joined any communities." };
const meta = { title: "App/Community/YourCommunitiesPage", component: YourCommunitiesPageView, args: { ...base, followingCommunities: communities, joinedCommunities: [communities[0]!], onCreateCommunity: () => undefined, onSelectCommunity: () => undefined }, parameters: { layout: "fullscreen" } } satisfies Meta<typeof YourCommunitiesPageView>;
export default meta;
...
export const MobileTabs: Story = { parameters: { viewport: { defaultViewport: "mobile1" } }, render: () => <StoryView {...base} followingCommunities={communities} joinedCommunities={[]} /> };
