      ...
      <DialogContent class="gap-0 overflow-hidden p-0 sm:w-[min(100%-2rem,30rem)]">
        <DialogHeader class="border-b border-border-soft bg-black px-6 py-7 pe-16 text-white">
          <div class="mb-4 flex items-center gap-3">
            <span aria-hidden="true" class="grid size-10 place-items-center rounded-full border border-white/25 bg-white/10 text-sm font-semibold">P</span>
            <span class="text-sm font-semibold tracking-[0.24em] text-white/70">PIRATE</span>
          </div>
