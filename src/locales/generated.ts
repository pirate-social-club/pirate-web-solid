  ...
  "ar": {
    ...
    "routes": {
      ...
      "communityCreationProgress": {
        ...
        "preBoundaryVerificationBody": "لا يمكن إكمال هذه المسودة القديمة هنا. أغلقها وابدأ مجتمعًا جديدًا؛ عمليات الإنشاء الجديدة لا تتطلب التحقق من الهوية.",
        ...
        "statusVerificationRequired": "مسودة إنشاء قديمة",
        "title": "إنشاء المجتمع",
  ...
  "en": {
    ...
    "routes": {
      ...
      "communityCreationProgress": {
        ...
        "preBoundaryVerificationBody": "This older draft cannot be completed here. Close it and start a new community; new creations do not require identity verification.",
        ...
        "statusVerificationRequired": "Older creation draft",
  ...
  "zh": {
    ...
    "routes": {
      ...
      "communityCreationProgress": {
        ...
        "preBoundaryVerificationBody": "此旧版草稿无法在这里完成。请关闭它并重新创建社区；新的创建流程不需要身份验证。",
        ...
        "statusVerificationRequired": "旧版创建草稿",
        "title": "创建社区",
        "viewCommunity": "查看社区",
