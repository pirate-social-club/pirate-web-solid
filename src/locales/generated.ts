  ...
  "ar": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "joinPolicyFraming": "كل من ينضم يمسح راحة يده. يمكنك أيضًا تحديد العضوية حسب الجنسية.",
        "joinPolicyTitle": "من يمكنه الانضمام",
        "nameLabel": "الاسم",
        "namePlaceholder": "مثال: غرفة الإشارة",
        "nameRequired": "الاسم مطلوب.",
        "nationalityDescription": "يثبت الأعضاء المنضمون جنسيتهم بوثيقة مدعومة. يمكنك اختيار الدول التي تسمح بها.",
  ...
  "en": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "joinPolicyFraming": "Everyone who joins scans their palm. You can also limit membership by nationality.",
        "joinPolicyTitle": "Who can join",
        "nameLabel": "Name",
        "namePlaceholder": "e.g. Signal Room",
        "nameRequired": "Name is required.",
        "nationalityDescription": "Joining members prove their nationality on a supported document. You can pick the countries you allow.",
  ...
  "zh": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "joinPolicyFraming": "每位加入者都需扫描手掌。你也可以按国籍限制成员资格。",
        "joinPolicyTitle": "谁可以加入",
        "nameLabel": "名称",
        "namePlaceholder": "例如：信号室",
        "nameRequired": "名称为必填项。",
        "nationalityDescription": "加入的成员需用受支持的证件证明国籍。你可以选择允许的国家。",
