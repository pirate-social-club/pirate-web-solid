  ...
  "ar": {
    ...
    "routes": {
      ...
      "names": {
        ...
        "labelUnavailable": "أدخل اسمًا متاحًا يشمله عرض المجتمع الحالي.",
  ...
  "en": {
    ...
    "routes": {
      ...
      "names": {
        ...
        "labelPlaceholder": "your-name",
        "labelUnavailable": "Enter an available name covered by this community's current offer.",
  ...
  "zh": {
    ...
    "routes": {
      ...
      "names": {
        ...
        "labelPlaceholder": "your-name",
        "labelUnavailable": "请输入该社区当前方案涵盖的可用名称。",
