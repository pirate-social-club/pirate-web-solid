  ...
  "ar": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "ownerPublicNameLabel": "الاسم العلني",
        "ownerUseExisting": "استخدام ملف شخصي موجود",
        "profileScope": "كل مجتمع تنشئه أو تنضم إليه يحصل على ملفه الشخصي الخاص.",
  ...
  "en": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "ownerPublicNameLabel": "Public name",
        "ownerUseExisting": "Use an existing profile",
        "profileScope": "Each community you create or join gets its own profile.",
  ...
  "zh": {
    ...
    "routes": {
      ...
      "createCommunity": {
        ...
        "ownerPublicNameLabel": "公开名称",
        "ownerUseExisting": "使用现有资料",
        "profileScope": "你创建或加入的每个社区都会有各自的个人资料。",
        "removeImage": "移除图片",
