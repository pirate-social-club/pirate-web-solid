...
export function SidebarGroupLabel(props: ParentProps<{ class?: string }>) {
  return (
    <div
      ...
      class={cn(
        "flex h-9 shrink-0 items-center rounded-md px-3 text-base font-medium text-sidebar-foreground outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-5 [&>svg]:shrink-0",
