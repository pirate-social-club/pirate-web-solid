...
/* Source digest: be8a45661c5c450b5081f09f718704fafb0ceba5f80088d336cb8ac14a17bb9e. */
...
export function IconGearSix(props: IconProps) {
  const iconProps = splitIconProps(props);
  return (
    <svg aria-hidden={iconProps.ariaHidden ?? "true"} class={iconProps.className} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...iconProps.rest}>
...
export function IconFadersHorizontal(props: IconProps) {
  const iconProps = splitIconProps(props);
  return (
    <svg aria-hidden={iconProps.ariaHidden ?? "true"} class={iconProps.className} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...iconProps.rest}>
...
export function IconTelegramLogo(props: IconProps) {
  const iconProps = splitIconProps(props);
  return (
    <svg aria-hidden={iconProps.ariaHidden ?? "true"} class={iconProps.className} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...iconProps.rest}>
      <Show
...
export function IconChatCircleDots(props: IconProps) {
  const iconProps = splitIconProps(props);
  return (
    <svg aria-hidden={iconProps.ariaHidden ?? "true"} class={iconProps.className} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...iconProps.rest}>
      <Show
...
export function IconImageSquare(props: IconProps) {
  const iconProps = splitIconProps(props);
  return (
    <svg aria-hidden={iconProps.ariaHidden ?? "true"} class={iconProps.className} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" {...iconProps.rest}>
      <Show
